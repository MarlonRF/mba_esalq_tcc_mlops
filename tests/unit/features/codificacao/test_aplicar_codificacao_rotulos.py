...
class TestAplicarCodificacaoLabel:
    ...
    def test_codificacao_multiplas_colunas(self):
        ...
        from src.processamento.codificacao.aplicar_codificacao_label import aplicar_codificacao_label
        ...
        df_resultado, artefatos = aplicar_codificacao_label(df, ["fruta", "cor"])
    ...
    def test_colunas_inexistentes_ignoradas(self):
        ...
        df_resultado, artefatos = aplicar_codificacao_label(df, ["A", "B", "C"])
    ...
    def test_sufixo_personalizado(self):
        ...
        df_resultado, _ = aplicar_codificacao_label(df, ["categoria"], sufixo="_encoded")
    ...
    def test_dataframe_original_nao_modificado(self):
        ...
        aplicar_codificacao_label(df, ["col"])
